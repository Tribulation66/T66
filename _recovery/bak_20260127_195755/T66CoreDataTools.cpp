...
#include "T66/Data/Schema/T66MiasmaRulesRow.h"
#include "T66/Data/Schema/T66ArenaRulesRow.h"
#include "T66/Data/Schema/T66AntiCheatRulesRow.h"
#include "T66/Data/Schema/T66DodgeRulesRow.h"
#include "T66/Data/Schema/T66CoopRulesRow.h"
#include "T66/Data/Schema/T66StageLoopRulesRow.h"
...
bool FT66CoreDataTools::CreateOrRepairAndValidateCoreData(bool /*bForceOverwrite*/)
{
        ...
        // NEW: Anti-cheat rules (rules table)
        UDataTable* DT_AntiCheatRules = EnsureDataTable(TablesRoot + TEXT("/Sec"), TEXT("DT_AntiCheatRules"), FT66AntiCheatRulesRow::StaticStruct());

        // NEW: Dodge rules (rules table)
        UDataTable* DT_DodgeRules = EnsureDataTable(TablesRoot + TEXT("/Sec"), TEXT("DT_DodgeRules"), FT66DodgeRulesRow::StaticStruct());
        ...
        // NEW: Miasma Rules (rules table)
        UDataTable* DT_MiasmaRules = EnsureDataTable(TablesRoot + TEXT("/Stages"), TEXT("DT_MiasmaRules"), FT66MiasmaRulesRow::StaticStruct());

        // NEW: Arena Rules (rules table)
        UDataTable* DT_ArenaRules = EnsureDataTable(TablesRoot + TEXT("/Stages"), TEXT("DT_ArenaRules"), FT66ArenaRulesRow::StaticStruct());

        // NEW: Stage loop rules (rules table)
        UDataTable* DT_StageLoopRules = EnsureDataTable(TablesRoot + TEXT("/Stages"), TEXT("DT_StageLoopRules"), FT66StageLoopRulesRow::StaticStruct());

        // NEW: Co-op rules (rules table)
        UDataTable* DT_CoopRules = EnsureDataTable(TablesRoot + TEXT("/Coop"), TEXT("DT_CoopRules"), FT66CoopRulesRow::StaticStruct());
        ...
        Catalog->AntiCheatRulesTable = DT_AntiCheatRules;
        Catalog->DodgeRulesTable = DT_DodgeRules;

        // Pointers
        Catalog->UltimatesTable = DT_Ultimates;
        Catalog->WhiteItemsTable = DT_WhiteItems;
        Catalog->MiasmaRulesTable = DT_MiasmaRules;
        Catalog->ArenaRulesTable = DT_ArenaRules;
        Catalog->StageLoopRulesTable = DT_StageLoopRules;
        Catalog->CoopRulesTable = DT_CoopRules;
        ...
        bOk &= ValidateDT(TEXT("DT_AntiCheatRules"), DT_AntiCheatRules, FT66AntiCheatRulesRow::StaticStruct());
        bOk &= ValidateDT(TEXT("DT_DodgeRules"), DT_DodgeRules, FT66DodgeRulesRow::StaticStruct());
        ...
        bOk &= ValidateDT(TEXT("DT_MiasmaRules"), DT_MiasmaRules, FT66MiasmaRulesRow::StaticStruct());
        bOk &= ValidateDT(TEXT("DT_ArenaRules"), DT_ArenaRules, FT66ArenaRulesRow::StaticStruct());
        bOk &= ValidateDT(TEXT("DT_StageLoopRules"), DT_StageLoopRules, FT66StageLoopRulesRow::StaticStruct());
        bOk &= ValidateDT(TEXT("DT_CoopRules"), DT_CoopRules, FT66CoopRulesRow::StaticStruct());
        ...
        bOk &= ValidateCatalogPtr(TEXT("AntiCheatRulesTable"), Catalog->AntiCheatRulesTable);
        bOk &= ValidateCatalogPtr(TEXT("DodgeRulesTable"), Catalog->DodgeRulesTable);
        ...
        bOk &= ValidateCatalogPtr(TEXT("MiasmaRulesTable"), Catalog->MiasmaRulesTable);
        bOk &= ValidateCatalogPtr(TEXT("ArenaRulesTable"), Catalog->ArenaRulesTable);
        bOk &= ValidateCatalogPtr(TEXT("StageLoopRulesTable"), Catalog->StageLoopRulesTable);
        bOk &= ValidateCatalogPtr(TEXT("CoopRulesTable"), Catalog->CoopRulesTable);
