...
public:
        ...
        // Boss-only rules (bosses still exist as enemies in DT_Enemies)
        UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="T66|Catalog")
        ...
        UPROPERTY(EditDefaultsOnly, Category="T66|Catalog|Sec")
        TSoftObjectPtr<UDataTable> AntiCheatRulesTable;
        UPROPERTY(EditDefaultsOnly, Category="T66|Catalog|Sec")
        TSoftObjectPtr<UDataTable> DodgeRulesTable;
        ...
        // Stage / run rules DTs (tuning knobs, not rosters)

        UPROPERTY(EditDefaultsOnly, Category="T66|Catalog|Stage")
        TSoftObjectPtr<UDataTable> MiasmaRulesTable;
        UPROPERTY(EditDefaultsOnly, Category="T66|Catalog|Stage")
        TSoftObjectPtr<UDataTable> ArenaRulesTable;
        UPROPERTY(EditDefaultsOnly, Category="T66|Catalog|Stage")
        TSoftObjectPtr<UDataTable> StageLoopRulesTable;

        UPROPERTY(EditDefaultsOnly, Category="T66|Catalog|Coop")
        TSoftObjectPtr<UDataTable> CoopRulesTable;
